...
{
    const FVmdObject::FHeader Header;


    const TArray<FVmdObject::FBoneKeyFrame> BoneKeyFrames;

    const TArray<FVmdObject::FMorphKeyFrame> MorphKeyFrames;

    const TArray<FVmdObject::FCameraKeyFrame> CameraKeyFrames;

    const TArray<FVmdObject::FLightKeyFrame> LightKeyFrames;

    const TArray<FVmdObject::FSelfShadowKeyFrame> SelfShadowKeyFrames;
    ...
    const TArray<FPropertyKeyFrameWithIkState> PropertyKeyFrames;
};
